//! HID input. Button bit positions are packed by the shim to match
...
/// Circle pad reaches roughly +/-156 on real hardware.
const STICK_RANGE: f32 = 156.0;

impl Input for N3dsInput {
